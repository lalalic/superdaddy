...
export default class Movable extends Component{
    ...
    componentDidMount(){
        ...
        container.addEventListener("mousemove",e=>{
            ...
            if(!moving)
                return 
            container.style=`cursor:move;positon:absolute; left: ${left+(e.clientX-x)}px !important; top:${top+(e.clientY-y)}px !important;bottom:auto !important;right:auto !important`
        })
