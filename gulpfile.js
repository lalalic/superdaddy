...
gulp.task('build',shell.task('watchify -d index.js -o www/index.js --ignore jquery'))
    ...
    .task('test', shell.task('karma start'))
    .task('default',['watchallin1'], shell.task('restmock'))
