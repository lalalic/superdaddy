...
export default class Dashboard extends Component{
            ...
            <div>
                ...
                <CommandBar
                    ...
                    items={[
                        ...
                        {action:"Publish", label:"Publish", icon:require("material-ui/lib/svg-icons/image/camera-roll")},
                        ...
                        {action:"setting", label:"Account", icon: require('material-ui/lib/svg-icons/action/account-box')}
                        ]}
                    />
            </div>
        )
    ...
    onSelect(command,e){
        ...
        case 'setting':
            ...
            break
        case 'Publish':
            this.context.router.transitionTo('publish')
            break
        case 'Refresh':
