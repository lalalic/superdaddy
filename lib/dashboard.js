        ...
        return (
            <div>
                ...
                <CommandBar
                    ...
                    />
                <TaskQueryCommand ref="task" when={when} onChange={this.onChangeDate.bind(this)}/>
        ...
        return (
            <List model={dbTask.byDate({when:when})}
                ...
                empty={{
                    ...
                    text:`Find fun topic for ${child.name}`
                }}
                />
        )
    }
...
Dashboard.contextTypes=QueryFuture.contextTypes=TaskItem.contextTypes={
